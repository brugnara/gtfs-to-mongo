...
Handlers.prototype.createIndexes = function(db, dbname, cb) {
  switch(dbname) {
    ...
    case 'EXU_stops':
      ...
      break;
    case 'U_stop_times':
    case 'EXU_stops_times':
      db.collection(dbname).ensureIndex( { stop_id: 1, arrival_time: 1, departure_time: 1 }, cb);
      break;
    case 'U_trips':
    case 'EXU_trips':
    ...
    case 'EXU_transfers':
      ...
      break;
    case 'U_calendar_dates':
    case 'EXU_calendar_dates':
          ...
          async.waterfall([
            ...
            function(cb) {
              db.collection(dbname).drop(function(err, res) {
                ...
                err && console.error('YOU CAN IGNORE THIS ERROR:', err);
                cb(null);
              });
            },
            // 2: create collection
